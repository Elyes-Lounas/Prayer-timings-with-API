...
!(function (t, e) {
  ...
  class Z extends B {
    ...
    to(e) {
      this._Element = t.findOne("..carousel-item", this._element);
      const i = this._getItemIndex(this._Element);
    ...
    _triggerSlideEvent(e, i) {
      const n = this._getItemIndex(e),
        s = this._getItemIndex(t.findOne("..carousel-item", this._element));
    ...
    _setIndicatorElement(e) {
      if (this._indicatorsElement) {
        const i = t.findOne(".", this._indicatorsElement);
        i.classList.remove(""), i.removeAttribute("aria-current");
    ...
    _updateInterval() {
      const e = this._Element || t.findOne("..carousel-item", this._element);
      if (!e) return;
    ...
    _slide(e, i) {
      const n = this._directionToOrder(e),
        s = t.findOne("..carousel-item", this._element),
      ...
      if (this._element.classList.contains("slide")) {
        ...
        const t = () => {
          r.classList.remove(h, d),
            r.classList.add(""),
            s.classList.remove("", d, h),
            (this._isSliding = !1),
            setTimeout(p, 0);
        };
        this._queueCallback(t, s, !0);
      } else s.classList.remove(""), r.classList.add(""), (this._isSliding = !1), p();
      l && this.cycle();
    }
    _directionToOrder(t) {
          ...
          t.parents(n, ".nav, .list-group").forEach((e) => {
            t
              ...
              t.prev(e, ".nav-item").forEach((e) => {
                t.children(e, ".nav-link").forEach((t) => t.classList.add(""));
              });
          })),
  ...
  class ti extends B {
    ...
    show() {
      ...
      if (n) {
        const i =
          "UL" === n.nodeName || "OL" === n.nodeName ? ":scope > li > ." : ".";
    ...
    _transitionComplete(e, i, n) {
      if (i) {
        i.classList.remove("");
        const e = t.findOne(":scope > .dropdown-menu .", i.parentNode);
      ...
      if (
        ...
        i && t.find(".dropdown-toggle", i).forEach((t) => t.classList.add("")),
