...
class Carousel extends BaseComponent {
  ...
  to(e) {
    ...
    const t = this._getItemIndex(this._Element);
  ...
  _getItemByOrder(e, t) {
    ...
    return getNextElement(this._items, t, n, this._config.wrap);
  }
  _triggerSlideEvent(e, t) {
    const n = this._getItemIndex(e),
      i = this._getItemIndex(
        SelectorEngine.findOne(SELECTOR__ITEM, this._element)
      );
  ...
  _setIndicatorElement(e) {
    if (this._indicatorsElement) {
      const t = SelectorEngine.findOne(".", this._indicatorsElement);
      t.classList.remove(""), t.removeAttribute("aria-current");
      ...
      for (let t = 0; t < n.length; t++)
        if (
          ...
          n[t].classList.add(""), n[t].setAttribute("aria-current", "true");
          break;
        }
    }
  }
  ...
  _slide(e, t) {
    const n = this._directionToOrder(e),
      i = SelectorEngine.findOne(SELECTOR__ITEM, this._element),
    ...
    if (o && o.classList.contains("")) return void (this._isSliding = !1);
    if (this._isSliding) return;
    if (this._triggerSlideEvent(o, _).defaultPrevented) return;
    if (!i || !o) return;
    (this._isSliding = !0),
      a && this.pause(),
      this._setIndicatorElement(o),
      (this._Element = o);
    const h = () => {
    ...
    if (this._element.classList.contains("slide")) {
      ...
      const e = () => {
        o.classList.remove(c, E),
          o.classList.add(""),
          i.classList.remove("", E, c),
          (this._isSliding = !1),
          setTimeout(h, 0);
      };
      this._queueCallback(e, i, !0);
    } else
      i.classList.remove(""), o.classList.add(""), (this._isSliding = !1), h();
    a && this.cycle();
  }
  _directionToOrder(e) {
...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    let e, t;
    this._parent &&
      ((e = SelectorEngine.find(SELECTOR_S, this._parent).filter((e) =>
...
class Dropdown extends BaseComponent {
  ...
  _selectMenuItem({ key: e, target: t }) {
    ...
    n.length && getNextElement(n, t, "ArrowDown" === e, !n.includes(t)).focus();
  }
...
class Tooltip extends BaseComponent {
  ...
  toggle(e) {
    if (this._isEnabled)
      if (e) {
        ...
        (t._Trigger.click = !t._Trigger.click),
          t._isWithTrigger() ? t._enter(null, t) : t._leave(null, t);
      } else {
    ...
    e.classList.remove("show"),
      "ontouchstart" in document.documentElement &&
        []
          .concat(...document.body.children)
          .forEach((e) => EventHandler.off(e, "mouseover", noop)),
      (this._Trigger.click = !1),
      (this._Trigger.focus = !1),
      (this._Trigger.hover = !1);
  ...
  _enter(e, t) {
    (t = this._initializeOnDelegatedTarget(e, t)),
      e && (t._Trigger["focusin" === e.type ? "focus" : "hover"] = !0),
  ...
  _leave(e, t) {
    (t = this._initializeOnDelegatedTarget(e, t)),
      e &&
        (t._Trigger["focusout" === e.type ? "focus" : "hover"] =
  ...
  _isWithTrigger() {
    for (const e in this._Trigger) if (this._Trigger[e]) return !0;
    return !1;
  }
  _getConfig(e) {
...
class ScrollSpy extends BaseComponent {
  ...
  _process() {
    ...
    if ((this._scrollHeight !== t && this.refresh(), e >= n)) {
      ...
      this._Target !== e && this._activate(e);
    } else {
      if (this._Target && e < this._offsets[0] && this._offsets[0] > 0)
        return (this._Target = null), void this._clear();
      for (let t = this._offsets.length; t--; )
        this._Target !== this._targets[t] &&
          e >= this._offsets[t] &&
...
const NAME$1 = "tab",
  ...
  SELECTOR_ = ".",
  SELECTOR__UL = ":scope > li > .",
  SELECTOR_DATA_TOGGLE =
    '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
  SELECTOR_DROPDOWN_TOGGLE = ".dropdown-toggle",
  SELECTOR_DROPDOWN__CHILD = ":scope > .dropdown-menu .";
class Tab extends BaseComponent {
  ...
  show() {
    ...
    if (n) {
      const t = "UL" === n.nodeName || "OL" === n.nodeName ? SELECTOR__UL : ".";
  ...
  _activate(e, t, n) {
    const i = (
        !t || ("UL" !== t.nodeName && "OL" !== t.nodeName)
          ? SelectorEngine.children(t, ".")
          : SelectorEngine.find(SELECTOR__UL, t)
      )[0],
  ...
  _transitionComplete(e, t, n) {
    if (t) {
      t.classList.remove("");
      const e = SelectorEngine.findOne(SELECTOR_DROPDOWN__CHILD, t.parentNode);
