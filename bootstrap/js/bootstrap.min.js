...
!(function (t, e) {
  ...
  class et extends q {
    ...
    to(t) {
      this._Element = i.findOne("..carousel-item", this._element);
      const e = this._getItemIndex(this._Element);
    ...
    _triggerSlideEvent(t, e) {
      const s = this._getItemIndex(t),
        n = this._getItemIndex(i.findOne("..carousel-item", this._element));
    ...
    _setIndicatorElement(t) {
      if (this._indicatorsElement) {
        const e = i.findOne(".", this._indicatorsElement);
        e.classList.remove(""), e.removeAttribute("aria-current");
        ...
        for (let e = 0; e < s.length; e++)
          if (
            ...
            s[e].classList.add(""), s[e].setAttribute("aria-current", "true");
            break;
          }
      }
    }
    _updateInterval() {
      const t = this._Element || i.findOne("..carousel-item", this._element);
      if (!t) return;
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        n = i.findOne("..carousel-item", this._element),
      ...
      if (r && r.classList.contains("")) return void (this._isSliding = !1);
      if (this._isSliding) return;
      if (this._triggerSlideEvent(r, u).defaultPrevented) return;
      if (!n || !r) return;
      (this._isSliding = !0),
        l && this.pause(),
        this._setIndicatorElement(r),
        (this._Element = r);
      const g = () => {
      ...
      if (this._element.classList.contains("slide")) {
        ...
        const t = () => {
          r.classList.remove(h, d),
            r.classList.add(""),
            n.classList.remove("", d, h),
            (this._isSliding = !1),
            setTimeout(g, 0);
        };
        this._queueCallback(t, n, !0);
      } else n.classList.remove(""), r.classList.add(""), (this._isSliding = !1), g();
      l && this.cycle();
    }
    _directionToOrder(t) {
  ...
  class jt extends q {
    ...
    toggle(t) {
      if (this._isEnabled)
        if (t) {
          ...
          (e._Trigger.click = !e._Trigger.click),
            e._isWithTrigger() ? e._enter(null, e) : e._leave(null, e);
        } else {
    ...
    _enter(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t && (e._Trigger["focusin" === t.type ? "focus" : "hover"] = !0),
    ...
    _leave(t, e) {
      (e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._Trigger["focusout" === t.type ? "focus" : "hover"] =
    ...
    _isWithTrigger() {
      for (const t in this._Trigger) if (this._Trigger[t]) return !0;
      return !1;
    }
    _getConfig(t) {
  ...
  class Ft extends q {
    ...
    _process() {
      ...
      if ((this._scrollHeight !== e && this.refresh(), t >= s)) {
        ...
        this._Target !== t && this._activate(t);
      } else {
        if (this._Target && t < this._offsets[0] && this._offsets[0] > 0)
          return (this._Target = null), void this._clear();
        for (let e = this._offsets.length; e--; )
          this._Target !== this._targets[e] &&
            t >= this._offsets[e] &&
        ...
        : (s.classList.add(""),
          i.parents(s, ".nav, .list-group").forEach((t) => {
            i
              ...
              .forEach((t) => t.classList.add("")),
              i.prev(t, ".nav-item").forEach((t) => {
                i.children(t, ".nav-link").forEach((t) => t.classList.add(""));
              });
          })),
  ...
  class Ut extends q {
    ...
    show() {
      ...
      if (s) {
        const e =
          "UL" === s.nodeName || "OL" === s.nodeName ? ":scope > li > ." : ".";
    ...
    _transitionComplete(t, e, s) {
      if (e) {
        e.classList.remove("");
        const t = i.findOne(":scope > .dropdown-menu .", e.parentNode);
      ...
      if (
        ...
        e && i.find(".dropdown-toggle", e).forEach((t) => t.classList.add("")),
          t.setAttribute("aria-expanded", !0);
      }
      s && s();
    }
